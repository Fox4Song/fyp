...
for it in range(TRAINING_ITERATIONS + 1):
    ...
    #    shapes: [B, L], [B, L], [B, L]
    input_batch, label_batch, attention_mask_batch, target_mask_batch = (
        polygon_reader.causal_polygon_batch_few_shot_completion_task()
    )
...
final_checkpoint_path = f"final_tf_angle_model_{total_params}_params.pt"
torch.save(
    {
